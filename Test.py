...
if len(sys.argv) == 1:
    sys.exit('ERROR: Not enough command arguments supplied. Need an API key.')
years = [2016, 2017]
ds = DataStore(tba_auth_key=sys.argv[1], years=years)
empty_datastore = DataStore(years=years, empty=True)
